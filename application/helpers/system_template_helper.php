      ...
      <div flex class="hide-scroll">
          <nav class="scroll nav-light">
              ...
              <ul class="nav" ui-nav>
                ...
                <li class='<?=(sidebar($sidebar, ['order-menu'])) ? 'active' : ''?>'> 
                  <a href="<?= base_url()?>order-menu" >
                    <span class="nav-icon">
                      <i class="fa fa-book">
                      </i>
                    </span>
                    <span class="nav-text">Order Menu</span>
                  </a>
                </li>
                <li class='<?=(sidebar($sidebar, ['menu-mngmt'])) ? 'active' : ''?>'> 
                  <a href="<?= base_url()?>menu-mngmt" >
                    <span class="nav-icon">
                      <i class="fa fa-book">
                      </i>
                    </span>
                    <span class="nav-text">Menu Mngmt</span>
                  </a>
                </li>            
                <li class='<?=(sidebar($sidebar, ['product-mngnt'])) ? 'active' : ''?>'> 
                  <a href="<?= base_url()?>product-mngmt" >
                    <span class="nav-icon">
                      <i class="fa fa-book">
                      </i>
                    </span>
                    <span class="nav-text">Product Mngmt</span>
                  </a>
                </li>      
                <li class='<?=(sidebar($sidebar, ['stock-mngmt'])) ? 'active' : ''?>'> 
                  <a href="<?= base_url()?>stock-mngmt" >
                    <span class="nav-icon">
                      <i class="fa fa-book">  
                      </i>
                    </span>
                    <span class="nav-text">Stock Mngmt</span>
                  </a>
                </li>         
              </ul>
          </nav>
      ...
      <div flex-no-shrink class="b-t">
        <div class="nav-fold">
            ...
            <span class="pull-left">                        
                <div id="person-image-profile" style="background-image: url('<?= base_url()?>assets/images/Logo/logo-cafe.png')"></div>
                <i class="on b-white bottom"></i>                                       
            </span>
            <span class="clear hidden-folded p-x">
              <span class="block _500"><?=ucwords(@$session->first_name.' '.@$session->last_name)?></span>
    ...
    <div class="app-header white box-shadow">
        <div class="navbar">
            ...
            <div class="navbar-item pull-left h5" ng-bind="$state.current.data.title" id="pageTitle">
                <!-- <span class="text-muted text-xs">&nbsp;<?=@$session->first_name.' '.@$session->last_name;?></span> -->
                <span id="realdatetime"></span>
                ...
                <div class="dropdown-menu pull-right w-xl animated fadeInUp no-bg no-border no-shadow">
                    <div class="scrollable" style="max-height: 320px">
                      <ul class="list-group list-group-gap m-a-0" id="notif-lists">
                        <!-- <li class="list-group-item green-100 lt box-shadow-z0 b">
                          <span class="pull-left m-r">
                            <a href="<?php echo base_url()?>notification"><img src="<?php echo base_url()?>assets/images/default.jpg" alt="..." class="w-40 img-circle"></a>                            
                          </span>
                          <span class="clear block">
                            <label style="font-weight: bold;"></label><b>Business Establishment Name</b> <br>                            
                          </span>
                        </li> -->
                      </ul>
                    </div>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link clear" href data-toggle="dropdown">
                  <span class="avatar w-32">                    
                      <img src="<?= base_url()?>assets/images/Logo/logo-cafe.png" alt="<?= base_url()?>">
                      <i class="on b-white bottom"></i>                                      
                  </span>
                </a>
